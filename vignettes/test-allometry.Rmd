...
(pH <- with(entities, marginalTwinType[twinType] * marginalConviction[conviction]))
```
...
```{r}
G <- rbind(
  c(0, 1 / marginalTwinType[1], 0, -1 / marginalTwinType[2]),
  c(1,1, 0,0),
  c(1, 0, 1, 0),
  c(1,1,1,1)
)
mu = c(0, marginalTwinType[1], marginalConviction[1], 1)
pH <- iProjector(G, mu, v = entities$empirical)
pA <- iProjector(G, G %*% entities$empirical, v = pH$p)


G <- rbind(
  c(0, 0, -1 / marginalTwinType[1], 1 / marginalTwinType[2]),
  c(0,1, 0,1),
  #c(1, 0, 1, 0),
  c(1,1,1,1)
)
mu = c(0, marginalTwinType[2], 1)
pH1 <- iProjector(G, mu, v = entities$empirical)
pA1 <- iProjector(G, G %*% entities$empirical, v = pH$p)
